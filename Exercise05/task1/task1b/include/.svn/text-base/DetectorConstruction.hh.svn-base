...
public:
  ...
  G4ThreeVector SimpleBoxPosition() const  { return posSimpleBox; }
  ...
  G4ThreeVector SetSimpleBoxPosition(const G4ThreeVector & pos) { return posSimpleBox=pos; }
...
private:
  ...
  //!Construct a simple geometric configuration
  G4VPhysicalVolume* ConstructBox();
private:
  ...
  //@}
//! \name Geometry Simple Box
  //@{
  G4VPhysicalVolume* SimpleBoxPl;
  //@}
