...
void Analysis::PrepareNewRun(const G4Run* /*aRun*/ )
{
  ...
  if(m_ROOT_file) {
    ...
    G4Exception("Analysis::PrepareNewRun()", "task3a01", FatalException, "ROOT file task3.root has not been created!");
  }
...
void Analysis::EndOfRun(const G4Run* aRun)
{
  ...
  // solution Ex3.3
  // print the energy released for the specific particle
  //  G4cout<<"================="<<G4endl;
  // G4cout<<"  Normalized energy of GAMMA in central crystal: "<<thisRunCentralEMGamma/norm;
  // G4cout<<"================="<<G4endl;
...
void Analysis::AddEDepEM(G4double edep, G4double z, G4int copyno)
{
  ...
  //
  if(11 == copyno && z > -DBL_MAX)
    { thisEventCentralEM += edep; }


// solution Ex3.3
// add a "AND" condition to select the specific particle name
//  if(11 == copyno && z > -DBL_MAX && .....  == "gamma")
//   { 
// this.... += edep; }
